...
4. 在手环上进入<mark class="orange">**连接新设备模式**</mark>

5. 回到设备页面选择设备

6. Authkey 在登录小米账号的状态下会自动为你准备好，直接连接即可；未登录的话直接填入 Authkey 即可

7. Windows 需要在系统蓝牙设置中点击允许配对（可能会在<mark class="orange">**右下角弹出通知**</mark>，点击进去配对即可）
...
1. 小米运动健康是否<mark class="orange">**完全清除后台**</mark>（或“小米运动健康”的“附近的设备”权限是否处于关闭状态）

2. 表盘自定义工具、Notify For Xiaomi、GadgetBridge等<mark class="orange">**其它干扰项的权限均为关闭状态**</mark>，必要时可以直接卸载。（澎湃OS2用户可以尝试调整“互联互通服务”防止抢连接）

3. 手环是否进入<mark class="orange">**连接新设备模式**</mark>

4. 是否给 AstroBox<mark class="orange">**“附近的设备”、“蓝牙”、“位置获取”权限**</mark>

5. 电脑请检查是否有<mark class="orange">**蓝牙模块（4.0+）**</mark>，检查有没有在<mark class="orange">**电脑设置点击确认，手环点击确认**</mark>

6. 请尝试在系统蓝牙设置中<mark class="orange">**“忽略”你的手环**</mark>，然后尝试重新连接<mark class="orange">**（iOS 用户尤其需要尝试此步）**</mark>。Windows由于系统特性可以重启电脑再试。

7. 如果<mark class="orange">**蓝牙固件有更新版本**</mark>请在系统设置里<mark class="orange">**自行更新**</mark>

8. 安卓版本是否在<mark class="orange">**13 以上**</mark>
